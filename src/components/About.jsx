...
function About() {
  ...
  <section className='section1 '>
          ...
          <div className='row'>
                <div className='col-md-6 mb-2 mt-5'>
                    <div className="card  shadow p-4  d-flex justify-content-center align-items-center">
                      ...
                      <p className='mt-2' style={{fontSize:"15px"}}>As a Software Engineer, my expertise spans across a range of technologies, including <span style={{fontWeight:"bold"}}>Node.js, React.js, Bootstrap 5, Tailwind CSS, SQL, and Vanilla JavaScript.</span>  Leveraging modern development tools such as Vite, Git and GitHub, and design tools like figma , I ensure efficient and collaborative workflows in all my projects.</p>
                      <p className='mt-2' style={{fontSize:"15px"}}>As a seasoned data enthusiast, I&apos;ve mastered the art of <span style={{fontWeight:"bold"}}>web scraping with the renowned Node.js library, Puppeteer</span> . With this powerful tool at my disposal, I leave no stone unturned in the vast landscape of data extraction.</p>
                ...
                <div className='col-md-6 mb-2 mt-5'>
                    ...
                    <p className='mt-2' style={{fontSize:"15px"}}>I laid the foundation for my academic journey at <span style={{fontWeight:"bold"}}>Vihiga Friends High School,</span> where I cultivated a strong curiosity for the world of technology and its boundless possibilities.</p>
                    <p className='mt-2' style={{fontSize:"15px"}}>Driven by my passion for creating innovative solutions, I embarked on a <span style={{fontWeight:"bold"}}> Bachelor of Science in Software Engineering at Muranga University of Technology.</span> Throughout my four-year journey at the university, I have delved deep into the realms of software development, honing my skills in programming, software design, and problem-solving.</p>
    ...
    <div className='container-fluid mt-2 d-flex justify-content-center align-items-center' style={{backgroundColor:"#008080", height:"70px" }}>
      <a href="path_to_your_cv_file.pdf" download style={{textDecoration:"none"}}>
        <FaDownload className='mb-1 mt-3 mx-3' style={{fontSize: "40px", color: "white" }}  />
        <br />
        <p style={{ fontSize:"15px", color:"white"}}>Download CV</p>
      </a>
    </div>
    </section>
