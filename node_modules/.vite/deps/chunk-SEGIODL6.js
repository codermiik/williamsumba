...
var Context = (0, import_react11.createContext)(canUseDOM_default ? window : void 0);
...
function useWaitForDOMRef(ref, onResolved) {
  ...
  const [resolvedRef, setRef] = (0, import_react12.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react13.useRef)(inProp);
...
function useTransition({
  ...
  const isInitialRef = (0, import_react14.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react14.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react14.cloneElement)(children, {
    ref: combinedRef
  });
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react15.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react15.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react15.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react15.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react15.useState)(!show);
  const lastFocusRef = (0, import_react15.useRef)(null);
  (0, import_react15.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react15.useRef)();
  const removeKeydownListenerRef = (0, import_react15.useRef)();
...
var Fade = React10.forwardRef(({
  ...
  const handleEnter = (0, import_react16.useCallback)((node, isAppearing) => {
...
var Offcanvas = React17.forwardRef(({
  ...
  const modalManager = (0, import_react18.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react18.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react18.useState)(false);
  ...
  const renderBackdrop = (0, import_react18.useCallback)((backdropProps) => (0, import_jsx_runtime17.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React18.forwardRef((props, ref) => {
  const context = (0, import_react19.useContext)(NavbarContext_default);
...
var Navbar = React19.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react20.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react20.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return (0, import_jsx_runtime21.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime21.jsx)(SelectableContext_default.Provider, {
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-SEGIODL6.js.map
